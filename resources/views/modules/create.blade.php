            ...
            <form class="form-horizontal" method="POST" action="/modules">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="form-group label-floating is-empty">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Nombre del Modulo">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="form-group label-floating is-empty">
                            <label class="control-label"></label>
                            <input type="text" name="description" class="form-control" placeholder="Descripcion del Modulo">
                        </div>
                    </div>
